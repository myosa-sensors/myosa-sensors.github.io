...
image: https://github.com/myosa-sensors/myosa-sensors.github.io/blob/b1528ff23926013894af987f2a87e8638331194e/src/content/post/Submission_Guideline/Images/myosa-guidelines-cover.jpeg
tags:
- submission
- rules
- guidelines
...
* **Single Markdown File:** Each team must upload one `.md` file following the exact structure provided.
* **Local Media Only:** YouTube links are not allowed; videos must be local `.mp4` files.
* **Strict Naming Conventions:** Files must use lowercase names with no spaces.
...
### **Images**
All images must be placed in the **same folder** as your markdown file.
...
* **Videos:** Must be a local `.mp4` file located in the same folder as the markdown file.
...
1.  Markdown file format followed.
2.  Images added correctly.
3.  MP4 video uploaded locally.
4.  Proper overview and tech stack included.
5.  Commands and code formatted correctly.
